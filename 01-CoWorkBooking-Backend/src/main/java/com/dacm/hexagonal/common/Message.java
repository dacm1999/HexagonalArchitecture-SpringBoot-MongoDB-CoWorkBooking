...
public class Message {
    ...
    public static final String SPACE_NAME_ALREADY_EXISTS= "space name already exists";
    ...
    public static final String BOOKING_NAME_ALREADY_EXISTS= "booking name already exists";
